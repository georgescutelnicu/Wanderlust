...
- **API Integration:** VisualCrossing API for weather forecasting, APICountries for countries FAQ and Flags, Nominatim API for geocoding, trip.com for flight ticket booking, Unsplash API for city images.
- **API Docs:** Swagger UI.
- **Testing:** PyTest.
